...
public:
    ...
    //CONSTRUCTEUR
    void initialize(float x, float y, int w, int h, IntRect rectImg, const char *nomSprite,
                    bool alive);        // initialisation de l'alien, position, grosseur, quel info img, int i envoie dans un case switch pour aller chercher le sprite, le booléen si l'alien est vivant;
    ...
    void setAlive(
            bool alive);                                    //	Setteur pour mettre vivant ou non (true false) avec la collision bientot;
