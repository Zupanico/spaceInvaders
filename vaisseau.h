...
public:
	...
	void initialize(float x, float y, int w, int h, IntRect rectImg, const char* nomSprite);		// initialisation de l'alien, position, grosseur, quel info img, int i envoie dans un case switch pour aller chercher le sprite, le booléen si l'alien est vivant;
